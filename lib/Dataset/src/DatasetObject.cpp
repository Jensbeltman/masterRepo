...
int DatasetObject::size() const { return filenames.size(); }

bool DatasetObject::has_gt(int n){return false;}

bool DatasetObject::has_scores(int n){return false;}

std::vector<T4> DatasetObject::get_gt(unsigned int n) { return std::vector<T4>(); }

std::vector<double> DatasetObject::get_scores(unsigned int n) { return std::vector<double>(); }

std::vector<T4> DatasetObject::get_object_candidates(unsigned int n) { return std::vector<T4>(); }
